...
@section('content')
    <div class="grid gap-5 lg:gap-7.5">
        <!-- begin: grid -->
        <div class="grid lg:grid-cols-6 gap-y-5 lg:gap-7.5 items-stretch">
            <div class="lg:col-span-6">
                <div class="grid grid-cols-1 sm:grid-cols-4 gap-5 lg:gap-7.5 h-full items-stretch">
                    <style>
                        .channel-stats-bg {
                    ...
                    <div
                        class="card flex-col justify-between gap-6 bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                        {{-- <img alt="" class="w-7 mt-4 ms-5" src="assets/media/brand-logos/linkedin-2.svg" /> --}}
                        <div class="w-20 mt-4 ms-5 text-gray-800 dark:text-gray-400">
                            <i class="ki-solid ki-chart text-2xl">
                            </i>
                        </div>
